...
EVIL = pygame.image.load("assets/images/evil.png")
START = pygame.image.load("assets/images/homer.png")
GOAL = pygame.image.load("assets/images/donuts.png")
...
SIMPSONG = pygame.mixer.music.load("assets/audio/simpsong.mp3")
# Animations
