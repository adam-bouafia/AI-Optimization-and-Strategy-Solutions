...
class Game:
    ...
    def __init__(self, matrix=None):
        self.backgroundImage = pygame.image.load('assets/image/bg.png')
    ...
    def drawTile(self, tile):
        ...
        # self.display.blit(pygame.font.SysFont('comicsansms', 15)
    ...
    def drawQuitButton(self):
        ...
        buttonSurface = pygame.Surface((buttonWidth, buttonHeight), pygame.SRCALPHA)

        # Create a font object
        fontObj = pygame.font.SysFont('comicsansms', 40)

        # Render the text
        textSurface = fontObj.render('QUIT', True, (255, 255, 255))

        # Calculate the position to center the text
        textRect = textSurface.get_rect(center=(buttonWidth / 2, buttonHeight / 2))

        # Draw the text onto the button surface
        buttonSurface.blit(textSurface, textRect)

        # Draw the button surface onto the game window
        self.display.blit(buttonSurface, (self.screenSize[0] - buttonWidth - 20, 20))
